...
/** One-sided standard normal quantile z_α = Φ^{-1}(1-α). */
...
/** P(Y ≤ c) for Y ~ Binomial(n, p). c may be non-integer; uses floor. */
export function binomialCdf(n: number, p: number, c: number): number {
